...
module namespace http="http://marklogic.com/util/http";
...
declare function http:string-to-variant($string as xs:string*) as element(http:variant)* {
...
(:
declare function http:prepare-response($response as item()+) as item() {
